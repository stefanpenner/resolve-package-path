...
describe('resolvePackagePath', function () {
  ...
  describe('._findPackagePath', function () {
    ...
    it('finds child package.json', function () {
      let result = resolvePackagePath._findPackagePath(_cache, 'bar/package.json', foo.baseDir);
      assert.equal(
        result,
    ...
    it('finds parent package.json', function () {
      let result = resolvePackagePath._findPackagePath(_cache, 'foo/package.json', fooBar.baseDir);
      assert.equal(
        result,
  ...
  describe('resolvePackagePath', function () {
    ...
    it('baseDir were the end of the path does not exist, but the start does and if resolution proceeds would be a hit', function () {
      assert.equal(
        resolvePackagePath(caches, 'bar', path.join(foo.baseDir, 'node_modules', 'does-not-exist')),
